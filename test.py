...
T=1
test = Dynamics.Full_Drone_dryden(init, T, 10, -10, 5)
control = np.ones((6,1))*1



ss = StateSpace.ContStateSpace(6, (tuple(00 for i in range(3)) + tuple(-5 for i in range(3)), [10 for i in range(3)]+[5 for i in range(3)]),
